...
// Calculate relationships sharing the same start or end field 

const relatedRelationships = relationships.filter( 

(r) => 

(r.startTableId === e.startTableId && r.startFieldId === e.startFieldId) || 

(r.endTableId === e.endTableId && r.endFieldId === e.endFieldId) 

); 

const relationshipIndex = relatedRelationships.findIndex((r) => r.id === e.id); 

const totalRelated = relatedRelationships.length; 
