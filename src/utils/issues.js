...
function checkCircularTypeReferences(typeName, visited = []) { 

if (visited.includes(typeName)) { 

issues.push( 

i18n.t("circular_type_reference", { 
...
// Check if the field type references another custom type 

const referencedType = diagram.types.find((t) => t.name === field.type); 

if (referencedType && field.type !== typeName) { 

checkCircularTypeReferences(field.type, [...visited]); 
...
checkCircularTypeReferences(type.name); 
